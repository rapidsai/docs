...
[Burn Down]({% link releases/process.md %}#burn-down) | {{ site.data.releases.nightly.burndown.start | date: "%a, %b %e, %Y" }} | {{ site.data.releases.nightly.burndown.end | date: "%a, %b %e, %Y" }} | {{ site.data.releases.nightly.burndown.days }} days
...
[Burn Down]({% link releases/process.md %}#burn-down) | {{ site.data.releases.next_nightly.burndown.start | date: "%a, %b %e, %Y" }} | {{ site.data.releases.next_nightly.burndown.end | date: "%a, %b %e, %Y" }} | {{ site.data.releases.next_nightly.burndown.days }} days
