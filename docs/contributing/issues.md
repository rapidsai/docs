...
### See also
- [Contributing Code]({{ site.baseurl }}docs/contributing/code)
...
Issues are either assigned by team leads or picked in priority order. If you are unsure what to work on, follow this [guide]({{ site.baseurl }}docs/contributing/code#what-do-i-work-on).
