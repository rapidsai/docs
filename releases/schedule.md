...
-- | -- | -- | --
Development (cuDF/RMM/rapids-cmake/cugraph-ops/raft) | {{ site.data.previous_releases.2306.cudf_dev.start | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.cudf_dev.end | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.cudf_dev.days }} days
Development (others) | {{ site.data.previous_releases.2306.other_dev.start | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.other_dev.end | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.other_dev.days }} days
[Burn Down]({% link releases/process.md %}#burn-down)(cuDF/RMM/rapids-cmake/cugraph-ops/raft) | {{ site.data.previous_releases.2306.cudf_burndown.start | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.cudf_burndown.end | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.cudf_burndown.days }} days
[Burn Down]({% link releases/process.md %}#burn-down) (others) | {{ site.data.previous_releases.2306.other_burndown.start | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.other_burndown.end | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.other_burndown.days }} days
[Code Freeze/Testing]({% link releases/process.md %}#code-freeze) (cuDF/RMM/rapids-cmake/cugraph-ops/raft) | {{ site.data.previous_releases.2306.cudf_codefreeze.start | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.cudf_codefreeze.end | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.cudf_codefreeze.days }} days
[Code Freeze/Testing]({% link releases/process.md %}#code-freeze) (others) | {{ site.data.previous_releases.2306.other_codefreeze.start | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.other_codefreeze.end | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.other_codefreeze.days }} days
[Release]({% link releases/process.md %}#releasing) | {{ site.data.previous_releases.2306.release.start | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.release.end | date: "%a, %b %e" }} | {{ site.data.previous_releases.2306.release.days }} days
