...
RAPIDS will be migrating to a new branching strategy after the 25.10 release. The new
...
during the 25.12 development cycle, after the 25.10 release is completed.
...
git branch -m branch-25.12 main
git fetch upstream
...
Below is a table comparing the current and new branching strategies. Here, the current release is `YY.MM` (e.g. 25.10) and we denote the next release as `<YY.MM-next>` (e.g. 25.12).

Aspect | Current (25.10) | New Branching Strategy (25.12+)
-- | -- | --
