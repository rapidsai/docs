...
RAPIDS is planning to deprecate support of CUDA 12.5 Docker containers in Release `v25.02`, and to cease publishing CUDA 12.5 Docker containers before the `v25.02` release.  The CUDA 12.5 containers will be replaced by CUDA 12.8 containers.  We are continuing support for CUDA 11.8 and 12.0 containers.
